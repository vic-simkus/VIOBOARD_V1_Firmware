...
/*
	...
	in in both builds
 */
__attribute__((interrupt, shadow, no_auto_psv)) void SLAVE_INTERRUPT(void)
{
	turn_on_receive_led();
	...
	if (I2CSTATbits.D_NOT_A == 0) //data/address.  1 == last byte was data; 0 == last byte was address
	{
		/*
