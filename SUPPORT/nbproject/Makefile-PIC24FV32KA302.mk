...
SOURCEFILES_QUOTED_IF_SPACED=src/I2C/i2c_callbacks.c src/I2C/i2c_isr_master.c src/I2C/simkus_net.c src/I2C/i2c_logger_reg.c src/I2C/i2c.c src/I2C/i2c_logger.c src/I2C/i2c_isr_slave.c src/serial_comm.c src/support.c src/calibration.c src/support_asm.s src/eeprom_utils.s src/serial_comm_asm.S

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/I2C/i2c_callbacks.o ${OBJECTDIR}/src/I2C/i2c_isr_master.o ${OBJECTDIR}/src/I2C/simkus_net.o ${OBJECTDIR}/src/I2C/i2c_logger_reg.o ${OBJECTDIR}/src/I2C/i2c.o ${OBJECTDIR}/src/I2C/i2c_logger.o ${OBJECTDIR}/src/I2C/i2c_isr_slave.o ${OBJECTDIR}/src/serial_comm.o ${OBJECTDIR}/src/support.o ${OBJECTDIR}/src/calibration.o ${OBJECTDIR}/src/support_asm.o ${OBJECTDIR}/src/eeprom_utils.o ${OBJECTDIR}/src/serial_comm_asm.o
POSSIBLE_DEPFILES=${OBJECTDIR}/src/I2C/i2c_callbacks.o.d ${OBJECTDIR}/src/I2C/i2c_isr_master.o.d ${OBJECTDIR}/src/I2C/simkus_net.o.d ${OBJECTDIR}/src/I2C/i2c_logger_reg.o.d ${OBJECTDIR}/src/I2C/i2c.o.d ${OBJECTDIR}/src/I2C/i2c_logger.o.d ${OBJECTDIR}/src/I2C/i2c_isr_slave.o.d ${OBJECTDIR}/src/serial_comm.o.d ${OBJECTDIR}/src/support.o.d ${OBJECTDIR}/src/calibration.o.d ${OBJECTDIR}/src/support_asm.o.d ${OBJECTDIR}/src/eeprom_utils.o.d ${OBJECTDIR}/src/serial_comm_asm.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/I2C/i2c_callbacks.o ${OBJECTDIR}/src/I2C/i2c_isr_master.o ${OBJECTDIR}/src/I2C/simkus_net.o ${OBJECTDIR}/src/I2C/i2c_logger_reg.o ${OBJECTDIR}/src/I2C/i2c.o ${OBJECTDIR}/src/I2C/i2c_logger.o ${OBJECTDIR}/src/I2C/i2c_isr_slave.o ${OBJECTDIR}/src/serial_comm.o ${OBJECTDIR}/src/support.o ${OBJECTDIR}/src/calibration.o ${OBJECTDIR}/src/support_asm.o ${OBJECTDIR}/src/eeprom_utils.o ${OBJECTDIR}/src/serial_comm_asm.o

# Source Files
SOURCEFILES=src/I2C/i2c_callbacks.c src/I2C/i2c_isr_master.c src/I2C/simkus_net.c src/I2C/i2c_logger_reg.c src/I2C/i2c.c src/I2C/i2c_logger.c src/I2C/i2c_isr_slave.c src/serial_comm.c src/support.c src/calibration.c src/support_asm.s src/eeprom_utils.s src/serial_comm_asm.S
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-PIC24FV32KA302.mk dist/${CND_CONF}/${IMAGE_TYPE}/SUPPORT.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/src/I2C/i2c_callbacks.o: src/I2C/i2c_callbacks.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/I2C/i2c_callbacks.c  -o ${OBJECTDIR}/src/I2C/i2c_callbacks.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/I2C/i2c_callbacks.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DFCY=16000000UL -DI2C_SLAVE_REGISTER_COUNT=0x0F -save-temps=obj -DXPRJ_PIC24FV32KA302=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I"include" -mconst-in-data -O0 -msmart-io=1 -Werror -Wall -msfr-warn=off  
...
${OBJECTDIR}/src/serial_comm.o: src/serial_comm.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/serial_comm.o.d 
	@${RM} ${OBJECTDIR}/src/serial_comm.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/serial_comm.c  -o ${OBJECTDIR}/src/serial_comm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/serial_comm.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DFCY=16000000UL -DI2C_SLAVE_REGISTER_COUNT=0x0F -save-temps=obj -DXPRJ_PIC24FV32KA302=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I"include" -mconst-in-data -O0 -msmart-io=1 -Werror -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/src/serial_comm.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/src/I2C/i2c_callbacks.o: src/I2C/i2c_callbacks.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/I2C/i2c_callbacks.o.d 
	@${RM} ${OBJECTDIR}/src/I2C/i2c_callbacks.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/I2C/i2c_callbacks.c  -o ${OBJECTDIR}/src/I2C/i2c_callbacks.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/I2C/i2c_callbacks.o.d"        -g -omf=elf -DFCY=16000000UL -DI2C_SLAVE_REGISTER_COUNT=0x0F -save-temps=obj -DXPRJ_PIC24FV32KA302=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I"include" -mconst-in-data -O0 -msmart-io=1 -Werror -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/src/I2C/i2c_callbacks.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/src/support_asm.o: src/support_asm.s  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/support_asm.o.d 
	@${RM} ${OBJECTDIR}/src/support_asm.o 
	${MP_CC} $(MP_EXTRA_AS_PRE)  src/support_asm.s  -o ${OBJECTDIR}/src/support_asm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -omf=elf -DFCY=16000000UL -DI2C_SLAVE_REGISTER_COUNT=0x0F -save-temps=obj -DXPRJ_PIC24FV32KA302=$(CND_CONF)  -no-legacy-libc  -I"include" -Wa,-MD,"${OBJECTDIR}/src/support_asm.o.d",--defsym=__MPLAB_BUILD=1,-g,--no-relax$(MP_EXTRA_AS_POST)
	@${FIXDEPS} "${OBJECTDIR}/src/support_asm.o.d"  $(SILENT)  -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/src/eeprom_utils.o: src/eeprom_utils.s  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/eeprom_utils.o.d 
	@${RM} ${OBJECTDIR}/src/eeprom_utils.o 
	${MP_CC} $(MP_EXTRA_AS_PRE)  src/eeprom_utils.s  -o ${OBJECTDIR}/src/eeprom_utils.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -omf=elf -DFCY=16000000UL -DI2C_SLAVE_REGISTER_COUNT=0x0F -save-temps=obj -DXPRJ_PIC24FV32KA302=$(CND_CONF)  -no-legacy-libc  -I"include" -Wa,-MD,"${OBJECTDIR}/src/eeprom_utils.o.d",--defsym=__MPLAB_BUILD=1,-g,--no-relax$(MP_EXTRA_AS_POST)
	@${FIXDEPS} "${OBJECTDIR}/src/eeprom_utils.o.d"  $(SILENT)  -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/src/serial_comm_asm.o: src/serial_comm_asm.S  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/serial_comm_asm.o.d 
	@${RM} ${OBJECTDIR}/src/serial_comm_asm.o 
	${MP_CC} $(MP_EXTRA_AS_PRE)  src/serial_comm_asm.S  -o ${OBJECTDIR}/src/serial_comm_asm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/serial_comm_asm.o.d"  -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -omf=elf -DFCY=16000000UL -DI2C_SLAVE_REGISTER_COUNT=0x0F -save-temps=obj -DXPRJ_PIC24FV32KA302=$(CND_CONF)  -no-legacy-libc  -I"include" -Wa,-MD,"${OBJECTDIR}/src/serial_comm_asm.o.asm.d",--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1,-g,--no-relax$(MP_EXTRA_AS_POST)
	@${FIXDEPS} "${OBJECTDIR}/src/serial_comm_asm.o.d" "${OBJECTDIR}/src/serial_comm_asm.o.asm.d"  -t $(SILENT)  -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/src/serial_comm_asm.o: src/serial_comm_asm.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/serial_comm_asm.o.d 
	@${RM} ${OBJECTDIR}/src/serial_comm_asm.o 
	${MP_CC} $(MP_EXTRA_AS_PRE)  src/serial_comm_asm.S  -o ${OBJECTDIR}/src/serial_comm_asm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/serial_comm_asm.o.d"  -omf=elf -DFCY=16000000UL -DI2C_SLAVE_REGISTER_COUNT=0x0F -save-temps=obj -DXPRJ_PIC24FV32KA302=$(CND_CONF)  -no-legacy-libc  -I"include" -Wa,-MD,"${OBJECTDIR}/src/serial_comm_asm.o.asm.d",--defsym=__MPLAB_BUILD=1,-g,--no-relax$(MP_EXTRA_AS_POST)
	@${FIXDEPS} "${OBJECTDIR}/src/serial_comm_asm.o.d" "${OBJECTDIR}/src/serial_comm_asm.o.asm.d"  -t $(SILENT)  -rsi ${MP_CC_DIR}../  
